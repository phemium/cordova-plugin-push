...
var PushNotification = /*#__PURE__*/ (function () {
  ...
  _createClass(PushNotification, [
    ...
    {
      key: "finishCallRequest",
      value: function finishCallRequest() {
        var successCallback =
          arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
        var errorCallback =
          arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
        ...
        if (typeof errorCallback !== "function") {
          console.log(
            "PushNotification.finishCallRequest failure: failure parameter not a function"
          );
          return;
        }
        ...
        if (typeof successCallback !== "function") {
          console.log(
            "PushNotification.finishCallRequest failure: success callback " +
              "parameter must be a function"
          );
          return;
        }
    ...
    },
    {
      ...
      value: function changeLanguage(language) {
        ...
        if (typeof errorCallback !== "function") {
          console.log("PushNotification.changeLanguage failure: failure parameter not a function");
          return;
        }

        if (typeof successCallback !== "function") {
          console.log(
            "PushNotification.changeLanguage failure: success callback " +
              "parameter must be a function"
          );
          return;
        }
...
module.exports = {
  ...
  finishCallRequest: function finishCallRequest(successCallback, errorCallback) {
    exec(successCallback, errorCallback, "PushNotification", "finishCallRequest", []);
  },

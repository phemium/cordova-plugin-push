...
object PushConstants {
  ...
  const val CONSULTATION_CALL_REQUEST: String = "CONSULTATION_CALL_REQUEST"
  const val CALL_RESPONSE_ACTION_KEY: String = "CALL_RESPONSE_ACTION"
  const val CALL_ACCEPT_ACTION: String = "CALL_ACCEPT"
  ...
  const val DELETE_ENDUSER_SESSION: String = "deleteEnduserSession"

...
class PushNotification {
  ...
  finishCallRequest(successCallback = () => {}, errorCallback = () => {}) {
    if (typeof errorCallback !== "function") {
      console.log("finishCallRequest failure: failure parameter not a function");
      return;
    }

    if (typeof successCallback !== "function") {
      console.log("finishCallRequest failure: success callback " + "parameter must be a function");
      return;
    }

    exec(successCallback, errorCallback, "PushNotification", "finishCallRequest", []);
  }

  changeLanguage(successCallback = () => {}, errorCallback = () => {}, language) {
    if (typeof errorCallback !== "function") {
      console.log("changeLanguage failure: failure parameter not a function");
      return;
    }

    if (typeof successCallback !== "function") {
      console.log("changeLanguage failure: success callback " + "parameter must be a function");
      return;
    }
